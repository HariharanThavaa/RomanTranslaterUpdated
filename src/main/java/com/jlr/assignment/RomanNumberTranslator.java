...
public class RomanNumberTranslator {
     ...
     */
    private Map<Integer, Map<Integer, String>> catalog;
    ...
    /**
     * to initialize the values for catolog
     * In future we could retrieve these values from DB
     * @return
     */
    protected Map InitCatalog(){
        return Map.of(
